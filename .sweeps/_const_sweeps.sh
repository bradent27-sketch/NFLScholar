...
echo "2/5 REMATCH_WEIGHT_MULT done $(date)" >> "$log"
...
echo "3/5 PRIOR_SEASON_DEFENSE_RECENCY_FLOOR done $(date)" >> "$log"
...
echo "4/5 ROLE_MATCHUP_K done $(date)" >> "$log"
