...
from ui.tabs import (  # noqa: E402
    game_slate, player_search, depth_charts, defensive_yield, live_odds,
    player_compare, matchup_analyzer, weekly_fantasy, draft_hq,
)
...
_tab_modules = [game_slate, player_search, depth_charts, defensive_yield, live_odds, player_compare, matchup_analyzer, weekly_fantasy, draft_hq]
