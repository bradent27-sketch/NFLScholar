...
COLUMN_HELP = {
    ...
    'Wind': "This game's wind speed - recorded once played, forecast otherwise (Open-Meteo, keyless). \"Dome\" for an indoor game, where wind doesn't apply",
    'Temp': "This game's temperature - recorded once played, forecast otherwise (Open-Meteo, keyless). \"Dome\" for an indoor game, where temperature doesn't apply",
    'Precip': "This game's precipitation - forecast only (Open-Meteo has no historical precipitation field). \"Dome\" for an indoor game, where precipitation doesn't apply",
